function SkeletonCard(){
    return (
        <div className="animate-pulse motion-safe:animate-pulse bg-white dark:bg-gray-800 rounded-lg shadow w-full">
            <div className="bg-gray-200 dark:bg-gray-700 h-40 rounded-t-lg  w-full"/>
            <div className="p-4">
