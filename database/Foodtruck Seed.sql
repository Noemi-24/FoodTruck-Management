...
('Admin User', 'admin@foodtruck.com', '$2a$10$iGKnWve1ETbBVYWHjebIoeM9o6W/O7V9YVJixLCBBF1NWdZLGzBpq', '555-0100', 'ADMIN'),
('John Smith', 'john.smith@foodtruck.com', '$2a$10$iGKnWve1ETbBVYWHjebIoeM9o6W/O7V9YVJixLCBBF1NWdZLGzBpq', '555-0101', 'EMPLOYEE'),
...
-- Main Dishes
(1, 'Classic Street Taco', 'Seasoned protein with fresh toppings and salsa', 3.99, '/images/street-taco.jpg', TRUE, TRUE),
(1, 'Signature Bowl', 'Rice bowl with protein, vegetables, and house sauce', 10.99, '/images/signature-bowl.jpg', TRUE, FALSE),
(1, 'Grilled Wrap', 'Grilled tortilla with protein and fresh vegetables', 8.99, '/images/grilled-wrap.jpg', TRUE, FALSE),
(1, 'Specialty Platter', 'Combination platter with rice, beans, and protein', 12.99, '/images/specialty-platter.jpg', TRUE, TRUE),

-- Sandwiches
(2, 'Premium Sandwich', 'Artisan bread with premium toppings and spread', 9.99, '/images/premium-sandwich.jpg', TRUE, FALSE),
(2, 'Classic Burger', 'Grilled burger with lettuce, tomato, and special sauce', 8.99, '/images/classic-burger.jpg', TRUE, FALSE),
(2, 'Veggie Delight', 'Plant-based sandwich with fresh vegetables', 7.99, '/images/veggie-delight.jpg', TRUE, FALSE),

-- Beverages
(3, 'Fresh Juice', 'House-made fresh juice', 3.50, '/images/fresh-juice.jpg', TRUE, FALSE),
(3, 'Specialty Drink', 'Traditional specialty beverage', 3.50, '/images/specialty-drink.jpg', TRUE, FALSE),
(3, 'Bottled Soda', 'Assorted sodas (Coke, Sprite, Fanta)', 2.00, '/images/soda.jpg', TRUE, FALSE),
(3, 'Bottled Water', 'Premium bottled water', 1.50, '/images/water.jpg', TRUE, FALSE),

-- Desserts
(4, 'Sweet Treat', 'Classic sweet treat with cinnamon sugar', 4.50, '/images/sweet-treat.jpg', TRUE, FALSE),
(4, 'Specialty Dessert', 'House specialty dessert', 5.00, '/images/specialty-dessert.jpg', TRUE, FALSE),

-- Sides
(5, 'Premium Side', 'Extra portion of premium topping', 2.50, '/images/premium-side.jpg', TRUE, FALSE),
(5, 'Chips & Dip', 'House-made chips with signature dip', 3.99, '/images/chips-dip.jpg', TRUE, FALSE),
(5, 'Extra Sauce', 'Additional sauce portion', 1.50, '/images/extra-sauce.jpg', TRUE, FALSE);
